    ...
    <div>
      ...
      <div className="container mt-4">
        <div className="row mt-4">
          ...
          <div className="col">
            <h2>
              <i className="fa-solid fa-school me-3"></i>Welcome to the Student Portal!
            </h2>
        ...
        <div className="row text-center mt-4">
          <div className="col">
            <div className="card">
              <div className="card-header bg-primary text-white">Recent Activity</div>
          ...
          <div className="col">
            <div className="card">
              <div className="card-header bg-primary text-white">Reminders</div>
              <div className="card-body">
                <ul className="list-group">
                  <li className="list-group-item">
